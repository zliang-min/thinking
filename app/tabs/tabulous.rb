...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :articles_tab            ,    'Articles'            ,    root_path                     ,    true        ,    true        ],
      [    :rails_admin_main_tab    ,    'Rails Admin Main'    ,    rails_admin_dashboard_path    ,    true        ,    true        ],
      #-----------------------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                 |    DISPLAY TEXT          |    PATH                          |    VISIBLE?    |    ENABLED?    #
      #-----------------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      [    :articles            ,    :all_actions    ,    :articles_tab            ],
      [    :rails_admin_main    ,    :all_actions    ,    :rails_admin_main_tab    ],
      #----------------------------------------------------------------------------#
      #    CONTROLLER           |    ACTION          |    TAB                      #
      #----------------------------------------------------------------------------#
    ]
